...
var ShareTransferApi = (function (_super) {
     ...
     * </em>
     */
    ShareTransferApi.prototype.getSharetype = function (id, refresh, customHeaders) {
     ...
     *  - `data` – `{Object}` -
     */
    ShareTransferApi.prototype.approveTransfer = function (sharetransfer_id, action, customHeaders) {
        var _method = "GET";
        var _url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
     ...
     *  - `data` – `{Object}` -
     */
    ShareTransferApi.prototype.approveAllotment = function (sharetransfer_id, action, customHeaders) {
        var _method = "GET";
        var _url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
     ...
     *  - `data` – `{Object}` -
     */
    ShareTransferApi.prototype.listAllotments = function (company_id, customHeaders) {
        var _method = "GET";
        var _url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
