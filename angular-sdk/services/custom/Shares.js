 ...
 */
var SharesApi = (function (_super) {
    __extends(SharesApi, _super);
    function SharesApi(http, connection, models, auth, searchParams, errorHandler) {
     ...
     * </em>
     */
    SharesApi.prototype.getShareType = function (id, refresh, customHeaders) {
     ...
     * </em>
     */
    SharesApi.prototype.getShareholder = function (id, refresh, customHeaders) {
        if (refresh === void 0) { refresh = {}; }
        var _method = "GET";
        var _url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
     ...
     * </em>
     */
    SharesApi.prototype.patchOrCreate = function (data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
        var _url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/shares";
     ...
     * </em>
     */
    SharesApi.prototype.patchAttributes = function (id, data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
        var _url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/shares/:id";
     ...
     * i.e. `Shares`.
     */
    SharesApi.prototype.getModelName = function () {
        return "Shares";
    };
    return SharesApi;
}(base_service_1.BaseLoopBackApi));
SharesApi = __decorate([
    core_1.Injectable(),
