...
/**
 * Api services for the `CompanyType` model.
 */
var CompanyTypeApi = (function (_super) {
    __extends(CompanyTypeApi, _super);
    function CompanyTypeApi(http, connection, models, auth, searchParams, errorHandler) {
     ...
     * </em>
     */
    CompanyTypeApi.prototype.patchOrCreate = function (data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
     ...
     * </em>
     */
    CompanyTypeApi.prototype.patchAttributes = function (id, data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
        var _url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/companytypes/:id";
     ...
     * i.e. `CompanyType`.
     */
    CompanyTypeApi.prototype.getModelName = function () {
        return "CompanyType";
    };
    return CompanyTypeApi;
}(base_service_1.BaseLoopBackApi));
CompanyTypeApi = __decorate([
    core_1.Injectable(),
...
exports.CompanyTypeApi = CompanyTypeApi;
