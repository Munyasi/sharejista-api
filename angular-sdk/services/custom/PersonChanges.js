...
/**
 * Api services for the `PersonChanges` model.
 */
var PersonChangesApi = (function (_super) {
    __extends(PersonChangesApi, _super);
    function PersonChangesApi(http, connection, models, auth, searchParams, errorHandler) {
     ...
     * This usually means the response is a `PersonChanges` object.)
     * </em>
     */
    PersonChangesApi.prototype.getPerson = function (id, refresh, customHeaders) {
        if (refresh === void 0) { refresh = {}; }
        var _method = "GET";
        var _url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/PersonChanges/:id/Person";
        var _routeParams = {
            id: id
        };
        var _postBody = {};
     ...
     * </em>
     */
    PersonChangesApi.prototype.getCompany = function (id, refresh, customHeaders) {
        if (refresh === void 0) { refresh = {}; }
        var _method = "GET";
        var _url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/PersonChanges/:id/Company";
        var _routeParams = {
            id: id
        };
        var _postBody = {};
     ...
     * </em>
     */
    PersonChangesApi.prototype.patchOrCreate = function (data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
        var _url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/PersonChanges";
     ...
     * </em>
     */
    PersonChangesApi.prototype.patchAttributes = function (id, data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
        var _url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/PersonChanges/:id";
     ...
     * i.e. `PersonChanges`.
     */
    PersonChangesApi.prototype.getModelName = function () {
        return "PersonChanges";
    };
    return PersonChangesApi;
}(base_service_1.BaseLoopBackApi));
PersonChangesApi = __decorate([
    core_1.Injectable(),
...
exports.PersonChangesApi = PersonChangesApi;
