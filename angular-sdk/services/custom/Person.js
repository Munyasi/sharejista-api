...
var PersonApi = (function (_super) {
    ...
    function PersonApi(http, connection, models, auth, searchParams, errorHandler) {
     ...
     * </em>
     */
    PersonApi.prototype.getCompany = function (id, refresh, customHeaders) {
     ...
     * </em>
     */
    PersonApi.prototype.patchOrCreate = function (data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
        var _url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/persons";
     ...
     * </em>
     */
    PersonApi.prototype.patchAttributes = function (id, data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
        var _url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/persons/:id";
     ...
     * i.e. `Person`.
     */
    PersonApi.prototype.getModelName = function () {
        return "Person";
    };
    return PersonApi;
}(base_service_1.BaseLoopBackApi));
PersonApi = __decorate([
    core_1.Injectable(),
